    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li <?php if (stripos($_SERVER['REQUEST_URI'],'WhatWeDo') !== false) { echo "class='nav-item active'";} else { echo "class='nav-item'";} ?>><a href=".?action=About" class="nav-link">About Us</a></li>
          <li <?php if (stripos($_SERVER['REQUEST_URI'],'WhatWeDo') !== false) { echo "class='nav-item active'";} else { echo "class='nav-item'";} ?>><a href=".?action=Team" class="nav-link">Team</a></li>
