      ...
      <div class="block-30 block-30-sm item" style="background-image: url('images/bg_01.png');" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-7">
              <h2 class="heading mb-5">Projects</h2>
            </div>
          </div>
        </div>
      </div>
...
<div class="site-section mb-5">
   <div class="container">
	...
	<div class="card mb-4 text-white" style="max-width: 1200px;background:#d72980;color:#fff;">
		...
		<div class="col-md-8">
			<div class="card-body">
				<h3 class="card-title" style="color:#fff;">Project Palaash</h3>
				...
				<a class="btn btn-light" href=".?action=Palaash" role="button">More...</a>
			</div>
		</div>
	   </div>
      </div>
      
      	<div class="card mb-4 text-white" style="max-width: 1200px;background:#137b13;color:#fff;">
		<div class="row no-gutters">
			<div class="col-md-3" style="background:#fff;">
				<img class="img-responsive" style="width:100%;height:100%;" src="images/suvidha.png" alt="Card image cap">
			</div>
		<div class="col-md-8">
			<div class="card-body">
				<h3 class="card-title" style="color:#fff;">Project Suvidha</h3>
				...
				<a class="btn btn-light" href=".?action=Suvidha" role="button">More...</a>
			</div>
		</div>
	   </div>
      </div>
